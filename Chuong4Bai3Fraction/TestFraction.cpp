#include"Fraction.h"
using namespace std;
void taoPhanSo(Fraction mangPhanSo[], int n)
{
	srand(time(NULL));
	for (int i = 0; i < 100; i++)
	{
...
void phanSoKhongVuotQua(Fraction mangPhanSo[])
{
	Fraction phanSo;
...
void phanSoKhongTrungNhau(Fraction mangPhanSo[])
{
	int count;
	for (int i = 0; i < 100; i++)
	{
